...
# Parameters: {'svm__tol': 1e-05, 'svm__shrinking': False, 'svm__kernel': 'linear', 'svm__gamma': 'auto', 'svm__degree': 3, 'svm__C': 0.001}
# Parameters: {'svm__tol': 0.001, 'svm__shrinking': True, 'svm__kernel': 'linear', 'svm__gamma': 'scale', 'svm__degree': 2, 'svm__C': 10}
clf = svm.SVC(tol=0.001, shrinking=True, kernel= 'linear', gamma= 'scale', degree= 2, C= 10).fit(X_train, y_train)
